...
/**
 * Created by yuanbo on 2019-03-25.
 */
public class QEncodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = "eefbf3cca60830313a95283c368687e3";
...
//        c.init(Cipher.ENCRYPT_MODE, desKey);
        c.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(encryptKey.getBytes(), "AES"));
        return  c.doFinal(content.getBytes("utf-8"));
    }
    ...
    public static String aesEncrypt(String content, String encryptKey) throws Exception {
        byte [] ss=aesEncryptToBytes(content, encryptKey);
